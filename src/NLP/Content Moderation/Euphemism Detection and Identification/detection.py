...
bert_tokenizer = BertTokenizer(vocab_file='Data/Datasets/BERT_model_reddit/vocab.txt')
print('Initialize BERT model...')
bert_model = BertForMaskedLM.from_pretrained('Data/Datasets/daaBERT_model_reddit').to(device)
bert_model.eval()
