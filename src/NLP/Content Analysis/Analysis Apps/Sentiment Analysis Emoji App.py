...
def main():
	...
	choice = st.sidebar.selectbox("Choices",activities)

	if choice == 'Sentiment':
		st.subheader("Sentiment Analysis")
		st.write(emoji.emojize('Everyone :red_heart: OpenEdu.ch ',use_aliases=True))
	...
	if choice == 'About':
		...
		st.text("Ibtihel Ouni")
		st.text("UniFire Team openEdu E")
